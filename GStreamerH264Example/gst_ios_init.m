...
gst_ios_init (void)
{
    ...
    g_setenv ("TMP", tmp_dir, YES);
    g_setenv ("TEMP", tmp_dir, YES);
    g_setenv ("TMPDIR", tmp_dir, YES);
    g_setenv ("XDG_RUNTIME_DIR", resources_dir, YES);
    g_setenv ("XDG_CACHE_HOME", cache_dir, YES);
    
    g_setenv ("HOME", docs_dir, YES);
    g_setenv ("XDG_DATA_DIRS", resources_dir, YES);
    g_setenv ("XDG_CONFIG_DIRS", resources_dir, YES);
    g_setenv ("XDG_CONFIG_HOME", cache_dir, YES);
    g_setenv ("XDG_DATA_HOME", resources_dir, YES);
    g_setenv ("FONTCONFIG_PATH", resources_dir, YES);
    
    ca_certificates = g_build_filename (resources_dir, "ssl", "certs", "ca-certifcates.crt", NULL);
    g_setenv ("CA_CERTIFICATES", ca_certificates, YES);
